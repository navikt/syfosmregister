...
val ORIGIN_COUNTER: Counter = Counter.build()
    .namespace(METRICS_NS)
    .name("origin_count")
    .labelNames("origin")
...
val REFERER_COUNTER: Counter = Counter.build()
    .namespace(METRICS_NS)
    .name("referer_count")
    .labelNames("referer")
...
val APP_ID_COUNTER: Counter = Counter.build()
    .namespace(METRICS_NS)
    .name("app_id_count")
    .labelNames("app_id")
    .help("Antall RESt-kall som har blitt gjort med ulike APP-IDer")
    .register()