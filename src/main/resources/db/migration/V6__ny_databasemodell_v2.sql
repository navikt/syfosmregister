-- Fjerner gammel versjon av
DROP TABLE SYKMELDINGSDOKUMENT;
DROP TABLE SYKMELDINGSMETADATA;
DROP TABLE BEHANDLINGSUTFALL;
DROP TABLE SYKMELDINGSOPPLYSNINGER;
...
(
    id         VARCHAR(64) PRIMARY KEY REFERENCES SYKMELDINGSOPPLYSNINGER ON DELETE CASCADE,
