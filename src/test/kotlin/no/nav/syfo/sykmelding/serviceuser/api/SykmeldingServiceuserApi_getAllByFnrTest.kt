...
class SykmeldingServiceuserApi_getAllByFnrTest : Spek({
    ...
    describe("Test sykmeldingServiceuserApi_getAllByFnr") {

        with(TestApplicationEngine()) {
            setUpTestApplication()
            application.routing { registrerSykmeldingServiceuserApiV1_getAllByFnr(sykmeldingerService = sykmeldingerService) }
            it("Skal få sykmeldinger for fnr") {
    ...
    describe("Test with autentication") {
        with(TestApplicationEngine()) {
            ...
            application.routing { authenticate("jwtserviceuser") { registrerSykmeldingServiceuserApiV1_getAllByFnr(sykmeldingerService = sykmeldingerServiceMedMock) } }
