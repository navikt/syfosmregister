...
internal class SykmeldingStatusConsumerServiceKafkaTest {
    ...
    @Test
    internal fun `SykmeldingStatusConsumerService read from statustopic Test APEN status`() {
    ...
    @Test
    internal fun `SykmeldingStatusConsumerService read from statustopic tombstone with APEN status`() {
    ...
    @Test
    internal fun `SykmeldingStatusConsumerService read from statustopic test tombstone with apen bekreft apen`() {
        val sykmeldingId = UUID.randomUUID().toString()
        val timestamp = getNowTickMillisOffsetDateTime().plusMonths(1)
        var sykmeldingStatusEvent: SykmeldingStatusEvent? = null
        val sykmeldingApenEvent =
    ...
    @Test
    internal fun `SykmeldingStatusConsumerService read from statustopic Test SENDT status`() {
        val sykmeldingId = UUID.randomUUID().toString()
        val timestamp = getNowTickMillisOffsetDateTime().plusMonths(1)
        var sykmeldingStatusEvent: SykmeldingStatusEvent? = null
    ...
    @Test
    internal fun `SykmeldingStatusConsumerService read from statustopic Test SENDT  SENDT`() {
        val sykmeldingId = UUID.randomUUID().toString()
        ...
        val producer = KafkaFactory.getSykmeldingStatusKafkaProducer(environment, kafkaConfig)
    ...
    @Test
    internal fun `SykmeldingStatusConsumerService read from statustopic test AVBRUTT status`() {
        val sykmeldingId = UUID.randomUUID().toString()
        val timestamp = getNowTickMillisOffsetDateTime().plusMonths(1)
        var sykmeldingStatusEvent: SykmeldingStatusEvent? = null
        val sykmeldingApenEvent =
    ...
    @Test
    internal fun `SykmeldingStatusConsumerService read from statustopic Test BEREFTET status`() {
    ...
    @Test
    internal fun `SykmeldingStatusConsumerService read from statustopic Test BEKREFTET til BEKREFTET`() {
        val sykmeldingId = "BEKREFT"
        val timestamp = getNowTickMillisOffsetDateTime().plusMonths(1)
        var sykmeldingStatusEvent: SykmeldingStatusEvent? = null
        var sykmeldingBekreftEvent: SykmeldingBekreftEvent? = null
    ...
    @Test
    internal fun `SykmeldingStatusConsumerService read from statustopic Test BEKREFTET til SENDT`() {
