    ...
    FunSpec({
        ...
        context("Test har redusertArbeidsgiverperiode no.nav.syfo.model.MedisinskVurdering") {
            test("Should not get redusert arbeidsgiverperiode") {
                ...
                val redusert =
                    diagnose.getHarRedusertArbeidsgiverperiode(periodeInnenforKoronaregler)
            ...
            test(
                "skal ikke gi redusert arbeidsgiverperiode hvis periode er før koronareglene gjelder"
            ) {
                getMedisinskVurdering(diagnoseKode = "R991")
                    .getHarRedusertArbeidsgiverperiode(periodeUtenforKoronaregler) shouldBe false
            }
            test(
                "skal gi redusert arbeidsgiverperiode hvis en av periodene er etter at koronareglene gjelder"
            ) {
                getMedisinskVurdering(diagnoseKode = "R991")
        ...
        context(
            "Test har redusertArbeidsgiverperiode no.nav.syfo.sykmelding.db.MedisinskVurdering"
        ) {
            test("Should not get redusert arbeidsgiverperiode") {
                val diagnose = getMedisinskVurderingDB(diagnoseKode = "123", bidiagnoseKode = "123")
                val redusert =
                    diagnose.getHarRedusertArbeidsgiverperiode(dbPeriodeInnenforKoronaregler)
                redusert shouldBe false
            }
            test("Should get redusert arbeidsgiverperiode for hoveddiagnose") {
