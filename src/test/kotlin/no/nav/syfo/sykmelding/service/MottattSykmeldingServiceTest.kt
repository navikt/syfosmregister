...
class MottattSykmeldingServiceTest :
    FunSpec({
        ...
        context("Test receive sykmelding") {
            ...
            test(
                "should receive sykmelding from automatic topic and publish to mottatt sykmelding topic"
            ) {
                val receivedSykmelding = getReceivedSykmelding()
            ...
            test(
                "should receive sykmelding med merknad from automatic topic and publish to mottatt sykmelding topic"
            ) {
            ...
            test(
                "should receive sykmelding from manuell topic and publish to mottatt sykmelding topic"
            ) {
                val receivedSykmelding = getReceivedSykmelding()
                mottattSykmeldingService.handleMessageSykmelding(
                    receivedSykmelding,
            ...
            test(
                "should receive sykmelding from avvist topic and not publish to mottatt sykmelding topic"
            ) {
                val receivedSykmelding = getReceivedSykmelding()
                mottattSykmeldingService.handleMessageSykmelding(
                    receivedSykmelding,
            ...
            test(
                "mottar utenlandsk sykmelding fra ok-topic publiserer på riktig format til mottatt-sykmelding-topic"
            ) {
                val receivedSykmelding =
