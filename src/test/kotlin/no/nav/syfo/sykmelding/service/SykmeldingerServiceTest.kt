...
class SykmeldingerServiceTest :
    FunSpec({
        ...
        context("Test SykmeldingerService") {
                ...
                coEvery { database.getSykmeldinger(any()) } returns
                    listOf(
                        getSykmeldingerDBmodel()
                            .copy(
                                status =
                                    StatusDbModel("APEN", getNowTickMillisOffsetDateTime(), null)
                            ),
                        getSykmeldingerDBmodel()
                            .copy(
                                status =
                                    StatusDbModel("AVBRUTT", getNowTickMillisOffsetDateTime(), null)
                            ),
                    )
            ...
            test(
                "Should not get medisinsk vurderering når sykmeldingen skal skjermes for pasient"
            ) {
                coEvery { database.getSykmeldinger(any()) } returns
            ...
            test(
                "harRedusertArbeidsgiverperiode skal være true hvis sykmeldingen har diagnosekode R991 som hoveddiagnose"
            ) {
                coEvery { database.getSykmeldingerMedId(any()) } returns
                    getSykmeldingerDBmodelEgenmeldt(
            ...
            test(
                "harRedusertArbeidsgiverperiode skal være true hvis sykmeldingen har bidiganose med diagnosekode U071 som hoveddiagnose"
            ) {
                coEvery { database.getSykmeldingerMedId(any()) } returns
                    getSykmeldingerDBmodelEgenmeldt(
            ...
            test(
                "harRedusertArbeidsgiverperiode skal være true hvis sykmeldingen har bidiganose med diagnosekode U072 som hoveddiagnose"
            ) {
                coEvery { database.getSykmeldingerMedId(any()) } returns
                    getSykmeldingerDBmodelEgenmeldt(
        ...
        context("Test av sykmeldtStatus") {
            ...
            test(
                "Skal få inneholderGradertPeriode = true hvis inneholder en periode med gradering"
            ) {
                ...
                val inneholderGradertPeriode =
                    sykmeldingerService.inneholderGradertPeriode(perioder)
